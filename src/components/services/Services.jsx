    ...
    <>
      <section className="services text-center">
        <div className="container">
          ...
          <div className="row">
            <div className="col-lg-4 col-md-6 content mt-5" data-aos="fade-up" data-aos-duration={1000}>
            ...
            <div className="col-lg-4 col-md-6 content mt-5" data-aos="fade-up" data-aos-duration={2000}>
            ...
            <div className="col-lg-4 col-md-6 content mt-5" data-aos="fade-up" data-aos-duration={3000}>
